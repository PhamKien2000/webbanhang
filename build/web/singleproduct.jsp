            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="ShowCart">Cart - <span class="cart-amunt">$100</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>${detail.price}</ins> <del>$100.00</del>
                                    </div>    
                                    ...
                                    <form action="" class="cart">
                                        ...
                                        <a href="cart?id=${detail.id}" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                    </form>   
