...
<html lang="en">
  ...
  <body>
    ...
    <div class="container tm-mt-big tm-mb-big">
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-15 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                ...
                <form method="post" action="ControllerProduct?ac=update"  class="tm-edit-product-form">
                ...
                <c:forEach var="t" items="${mrBean.category}">
                    <option   value="${t.id}" <c:if test="${c.idCa==t.id}">selected="true"</c:if>>
                                ${t.name}
                            </option>  
