          ...
          <div class="tm-bg-primary-dark tm-block tm-block-products">
            <div class="tm-product-table-container">
              <table class="table table-hover tm-table-small tm-product-table">
                ...
                <c:forEach var="s" items="${mrBean.category}">
                    <tr>
                        <td >${s.id}</td>
                        <td >${s.name}</td>
                        
                        <td ><img src="${s.img}" style="width:50px;height:50px"></td>
                        <td><a href="ControllerCategory?ac=del&id=${s.id}">Delete</a></td>
                        <td><a href="ControllerCategory?ac=edit&id=${s.id}">Edit</a></td>
                       <td><a href="ControllerCategory?ac=edit&id=${s.id}">Detail</a></td>
